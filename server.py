...
# These must match your 'engine' folder structure
...
# FIXED: Standard CORS policy to allow your frontend
app.add_middleware(
    CORSMiddleware,
    allow_origins=[
...
if __name__ == "__main__":
    ...
    # We use "server:app" as a string to match the Uvicorn standard
